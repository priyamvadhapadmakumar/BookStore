...
namespace BookStore.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public ExternalLoginModel(
            ...
            ILogger<ExternalLoginModel> logger) //removed IEmailSender emailSender
        {
            ...
            else
            {
                ...
                if (info.Principal.HasClaim(c => c.Type == ClaimTypes.Email))
                {
                    Input = new InputModel
                    {
                        ...
                        Name = info.Principal.FindFirstValue(ClaimTypes.Name) //add this to get name for user
                    };
                }
                return Page();
            }
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded) //if creation of new user successful
                    {
                        await _userManager.AddToRoleAsync(user, StaticDetails.Role_Customer); //assign role for user
