        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(StaticDetails.Roler_User_Company))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(StaticDetails.Roler_User_Company));
                    }
                    if (!await _roleManager.RoleExistsAsync(StaticDetails.Role_User_Independent))
                    {
